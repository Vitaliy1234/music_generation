...
from preprocessing.preprocessutilities import events_to_events_data

logger = logging.create_logger("music21jsb")


def preprocess_music21(file_list):
    """
    preprocess midis from directory
    :param file_list: list of midi files
    :return:
    """
    logger.info("Loading songs...")
    # songs = list(corpus.chorales.Iterator())
    songs = [converter.parse(file) for file in file_list]
